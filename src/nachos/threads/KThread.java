...
//PriorityScheduler.PriorityTest();
//PriorityScheduler.PriorityTest2();
//Boat.selfTest();
...
public static void joinSelfTest(){
	...
	a.fork();
	System.out.println("调用join方法，当前线程阻塞，thread 1 执行\n结束后thread 0 再执行【thread 0 为主线程】");
	a.join();
...
//private KThread waitForJoinThread = null;//存储等待join方法结束的线程
private int JoinCount = 0;//定义调用join的次数
public int getJoinCount() {
	return JoinCount;
}

//long waitForAccessTime;    
